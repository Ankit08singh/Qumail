    ...
    <section className="relative py-20 sm:py-32 bg-slate-900 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="group relative overflow-hidden bg-blue-600 hover:bg-blue-500 text-white px-8 sm:px-12 py-4 sm:py-6 rounded-2xl font-bold text-lg sm:text-xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        >
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-0 text-center">
          <div className="group">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-105 transition-transform">
              <Zap className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
            </div>
            <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2">256-bit</div>
            <div className="text-blue-400 text-xs sm:text-sm font-medium">Quantum Encryption</div>
          </div>
          <div className="group">
            ...
            <div className="text-blue-400 text-xs sm:text-sm font-medium">Uptime Guarantee</div>
          </div>
          <div className="group">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:scale-105 transition-transform">
            ...
            <div className="text-blue-400 text-xs sm:text-sm font-medium">Expert Support</div>
          </div>
        </div>
      </div>
    </section>
